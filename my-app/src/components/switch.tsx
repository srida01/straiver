...
const StyledWrapper = styled.div`
  ...
  .toggle-handle-knob {
    ...
    width: var(--knob-size);
    height: var(--knob-size);
    background-image: radial-gradient(farthest-corner at 70% 30%, #fedee2 4%,rgb(21, 218, 221) 12% 24%,rgb(14, 161, 210) 50% 65%,rgb(106, 184, 202) 75%);
    transition: transform .24s cubic-bezier(.65, 1.35, .5, 1);
  }
  ...
  .toggle-base-inside::after {
    ...
    width: 100%;
    height: 100%;
    background-image: linear-gradient(to bottom,rgb(19, 122, 131),rgb(36, 139, 145));
    box-shadow: inherit;
    opacity: 0;
